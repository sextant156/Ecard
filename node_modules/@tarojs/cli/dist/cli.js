...
class CLI {
    ...
    parseArgs() {
        ...
        if (command) {
            ...
            const expandEnv = (0, util_1.dotenvParse)(appPath, args.envPrefix, args.mode || process.env.NODE_ENV);
            ...
            if (initialConfig) {
                initialConfig.env = (0, util_1.patchEnv)(initialConfig, expandEnv);
            }
            if (command === 'doctor') {
            ...
            switch (command) {
                ...
                case 'build': {
                    ...
                    // 根据 framework 启用插件
                    const framework = (_b = kernel.config) === null || _b === void 0 ? void 0 : _b.initialConfig.framework;
                    switch (framework) {
                        case 'vue':
