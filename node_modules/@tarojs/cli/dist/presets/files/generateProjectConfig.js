...
exports.default = (ctx) => {
    ctx.registerMethod('generateProjectConfig', ({ srcConfigName, distConfigName }) => {
        ...
        if (((_a = ctx.initialConfig.logger) === null || _a === void 0 ? void 0 : _a.quiet) === false) {
            printLog("generate" /* processTypeEnum.GENERATE */, '工具配置', `${outputPath}/${distConfigName}`);
        }
    });
};
//# sourceMappingURL=generateProjectConfig.js.map