        ...
        try {
            if (!isWatch) {
                ...
                const devUrl = (0, url_1.format)({
                    protocol: ((_a = webpackConfig.devServer) === null || _a === void 0 ? void 0 : _a.https) ? 'https' : 'http',
                    hostname: (0, utils_1.formatOpenHost)((_b = webpackConfig.devServer) === null || _b === void 0 ? void 0 : _b.host),
                    port: (_c = webpackConfig.devServer) === null || _c === void 0 ? void 0 : _c.port,
