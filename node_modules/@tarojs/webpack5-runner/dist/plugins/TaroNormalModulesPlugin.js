...
const TaroNormalModule_1 = __importDefault(require("./TaroNormalModule"));
        ...
        compiler.hooks.compilation.tap(PLUGIN_NAME, (_, { normalModuleFactory }) => {
            normalModuleFactory.hooks.createModule.tapPromise(PLUGIN_NAME, (data, { dependencies }) => {
                ...
                if (dependency instanceof TaroSingleEntryDependency_1.default) {
                    return Promise.resolve(new TaroNormalModule_1.default(Object.assign(data, { miniType: dependency.miniType, name: dependency.name })));
                }
