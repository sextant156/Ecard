                ...
                if (this.isSubEntry(entryName)) {
                    ...
                    for (const key in FileExtsMap) {
                        ...
                        if (ext === FileExtsMap.JS || ext === FileExtsMap.STYLE) {
                            ...
                            if (this.assets[(0, helper_1.normalizePath)(subVendorsPath)]) {
                            ...
                            subCommon.forEach(moduleName => {
                                ...
                                const assetSource = this.assets[(0, helper_1.normalizePath)(moduleFilePath)];
                                if (assetSource) {
                                    ...
                                    this.assets[(0, helper_1.normalizePath)(subRootModuleFilePath)] = {
                                    ...
                                    if (ext === FileExtsMap.JS && originSourceMap) {
                                        ...
                                        this.assets[(0, helper_1.normalizePath)(subRootSourceMapFilePath)] = {
