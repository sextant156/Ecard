...
let INSTANCE_ID = 0;
const Swiper = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["taro-swiper-core"];
  components.forEach(tagName => { switch (tagName) {
    case "taro-swiper-core":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, Swiper);
      }
      break;
  } });
}

const TaroSwiperCore = Swiper;
const defineCustomElement = defineCustomElement$1;

export { TaroSwiperCore, defineCustomElement };
