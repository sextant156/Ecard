...
export interface TaroPullToRefreshCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLTaroPullToRefreshElement;
}
...
declare namespace LocalJSX {
    ...
    interface TaroPullToRefresh {
        ...
        "distanceToRefresh"?: number;
        "indicator"?: { activate: string; deactivate: string; release: string; finish: string; };
        "onRefresh"?: (event: TaroPullToRefreshCustomEvent<any>) => void;
        "prefixCls"?: string;
    }
    interface TaroRadioCore {
        "checked"?: boolean;
