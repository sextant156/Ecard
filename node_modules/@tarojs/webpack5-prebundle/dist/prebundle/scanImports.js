...
function scanImports({ appPath, chain, entries, include = [], exclude = [], customEsbuildConfig = {} }, deps = new Map()) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(entries.map((entry) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield helper_1.esbuild.build(Object.assign(Object.assign({}, customEsbuildConfig), { absWorkingDir: appPath, bundle: true, entryPoints: [entry], mainFields: ['main:h5', 'browser', 'module', 'jsnext:main', 'main'], format: 'esm', loader: helper_1.defaultEsbuildLoader, write: false, define: Object.assign(Object.assign({}, (0, utils_1.getDefines)(chain)), { define: 'false' }), plugins: [
                        scanImportsPlugin,
                        ...customPlugins
                    ] }));
            }
